...
out1 = main_segmentation_error_testing_v2(offFolder,annotationFolder_gt_curves,tamada_result_folder,our_method_cut_result_folder,ofer_output_folder,dorkenwalk_result_folder,[]);

tamada_error_all1 = out1.tamada_error_all;
tamada_error_all_dist1 = out1.tamada_error_all_dist;
tamada_error_all_iou1 = out1.tamada_error_iou;
our_method_error_all1 = out1.our_method_error_all;
our_method_error_all_dist1 = out1.our_method_error_all_dist ;
our_method_error_iou1 = out1.our_method_error_iou;
ofer_method_error_all1 = out1.ofer_method_error_all;
ofer_method_error_all_dist1  =    out1.ofer_method_error_all_dist;
ofer_method_error_iou1 = out1.ofer_method_error_iou;
dorkenwalk_error_iou1 = out1.dorkenwalk_error_iou;
dorkenwalk_error_all1 = out1.dorkenwalk_error_all;
dorkenwalk_error_all_dist1=  out1.dorkenwalk_error_all_dist;

nan_rm1 = find(isnan(tamada_error_all1)| isnan(our_method_error_all1) |isnan(ofer_method_error_all1)|isnan(dorkenwalk_error_all1));
nan_rm2 = find(isnan(tamada_error_all_dist1)| isnan(our_method_error_all_dist1) |isnan(ofer_method_error_all_dist1)|isnan(dorkenwalk_error_all_dist1));
na_rm3 = find(isnan(tamada_error_all_iou1)| isnan(our_method_error_iou1) |isnan(ofer_method_error_iou1)|isnan(dorkenwalk_error_iou1));
tamada_error_all1(nan_rm1) = [];
our_method_error_all1(nan_rm1) = [];
ofer_method_error_all1(nan_rm1) = [];
dorkenwalk_error_all1(nan_rm1) = [];
tamada_error_all_dist1(nan_rm2) = [];
our_method_error_all_dist1(nan_rm2) = [];
ofer_method_error_all_dist1(nan_rm2) = [];
dorkenwalk_error_all_dist1(nan_rm2) = [];
tamada_error_all_iou1(na_rm3) = [];
our_method_error_iou1(na_rm3) = [];

ofer_method_error_iou1(na_rm3) = [];
dorkenwalk_error_iou1(na_rm3) = [];
