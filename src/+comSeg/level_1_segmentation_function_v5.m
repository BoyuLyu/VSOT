function mask_spine_cell = level_1_segmentation_function_v5(mask_dendrite_cell, xxshift, yyshift,resx, resy, resz, minSpineSize)
%32xresyxresz
...
%     disp(i)
    ...
    %                      disp([ix, iy, iz])
        ...
        %                     tic;
                            ...
                            maskRemovetmp = comSeg.extract_shaft_v5(tmp_den, tmp_skel, tmp_dist,xxshift,yyshift,resx, resy, resz);
                            maskRemoveAll(winx(1,1):winx(1,2), winx(2,1):winx(2,2), winx(3,1):winx(3,2)) = maskRemovetmp;
                        end
                    end
                end
            end
