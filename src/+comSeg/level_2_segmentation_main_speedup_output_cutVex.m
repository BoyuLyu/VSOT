function level_2_segmentation_main_speedup_output_cutVex(spine_save_folder, spine_head_neck_save_folder, outputFolder, curvature_scale, resx, resy, resz,minpoints,smooth_kernel)
