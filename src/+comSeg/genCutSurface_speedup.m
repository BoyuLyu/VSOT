function [surfaceCell, nodeCell] = genCutSurface_speedup(cutVexcell, mF2, headp, neckp, Vnieuwx,Vnieuw, test_region2, allTetrax, allVertex)
%%
...
%         disp(i)
    ...
    %             bbNode2 =  bbNode - mean(bbNode,1);
                ...
                % surface
                [combinedSurface, verticesFin] = comSeg.combineSurface(cutMF, cutvertices, headHalf_surface, Vnieuw, Vnieuw(cutVex,:));
